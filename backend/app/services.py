...
ROUTE_CONFIG = {
    "NYC-WDC": {
        ...
        "carriers": [
            {"name": "Knight-Swift Transport Services", "trucks_per_day": 10, "logo": "https://logo.clearbit.com/knight-swift.com"},
            {"name": "J.B. Hunt Transport Services Inc", "trucks_per_day": 7, "logo": "https://logo.clearbit.com/jbhunt.com"},
            {"name": "YRC Worldwide", "trucks_per_day": 5, "logo": "https://logo.clearbit.com/yrcw.com"},
        ]
    },
    "SF-LA": {
        "cities": [
        ...
        "carriers": [
            {"name": "XPO Logistics", "trucks_per_day": 9, "logo": "https://logo.clearbit.com/xpo.com"},
            {"name": "Schneider", "trucks_per_day": 6, "logo": "https://logo.clearbit.com/schneider.com"},
            {"name": "Landstar Systems", "trucks_per_day": 2, "logo": "https://logo.clearbit.com/landstar.com"},
        ]
    }
}

DEFAULT_CARRIERS = [
    {"name": "UPS Inc.", "trucks_per_day": 11, "logo": "https://logo.clearbit.com/ups.com"},
    {"name": "FedEx Corp", "trucks_per_day": 9, "logo": "https://logo.clearbit.com/fedex.com"},
]
...
def generate_trucks_lazy(count: int, logo_url: str) -> List[Dict[str, Any]]:
    ...
    """
    return [
        generate_truck_data(i, logo_url)
...
def _get_route_config(from_city: str, to_city: str) -> Union[List[Dict[str, Any]], None]:
    """
